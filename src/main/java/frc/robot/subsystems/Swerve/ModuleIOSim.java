...
public class ModuleIOSim implements ModuleIO{
    ...
    private DCMotorSim driveSim = new DCMotorSim(DCMotor.getKrakenX60(1), Constants.gearRatio, 0.25);
    private DCMotorSim turnSim = new DCMotorSim(DCMotor.getKrakenX60(1), Constants.gearRatio, 0.04);
