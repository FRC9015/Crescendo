...
public class Module {
	...
	public Module(ModuleIO io, int index){
		...
		if (Robot.isSimulation()){
			...
			driveFeedback = new PIDController(0.1, 0.0, 0.0); // Sample PID Values
			turnFeedback = new PIDController(10.0, 0.0, 0.0); // Sample PID Values
		}else{
	...
	public SwerveModuleState getState(){
		return new SwerveModuleState(getPositionMeters(), getAngle());
	}
