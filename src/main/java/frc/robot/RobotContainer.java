...
public class RobotContainer {
	...
	//	InputManager.getInstance().getDriverButton(InputManager.Button.LT_Button7).onTrue((PIVOT.zeroPivot()));
		...
		// InputManager.getInstance().getOperatorButton(InputManager.Button.A_Button1).onTrue(PIVOT.flatCommand());
		 InputManager.getInstance().getOperatorButton(InputManager.Button.X_Button3).onTrue(PIVOT.intakeCommand());
		 InputManager.getInstance().getOperatorButton(InputManager.Button.A_Button1).onTrue(PIVOT.subWoofer());
